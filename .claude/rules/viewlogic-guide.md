...
- **결제/구독/청구/환불/해지 관련 페이지 구현 시**: `docs/billing.md` 참조하여 정책 확인 (결제 상태, 결제 실패 흐름, 환불 공식, 플랜 변경 규칙 등)

## 상세 문서
`docs/` 폴더에 기능별 상세 문서: routing, data-fetching, forms, api, auth, i18n, components, components-builtin, layout, patterns, advanced, configuration, billing
